...
Each vignette is stored in its own folder in the repository. Using your IDE of choice, open the vignette directory you'd like to run. Then, using the terminal inside youre IDE, run `flutter packages get` to fetch any dependencies, and `flutter run` to deploy to your connected device or simulator.
